...
<template>
    <div class="my-[60px]">
        <h2 class="text-center text-[3.5rem] mb-10 text-[var(--primary-color)] font-bold">Đơn hàng</h2>
        <div class="rounded border-solid border border-[var(--primary-color)]">
            ...
            >
                <span class="min-w-[100px] pr-[15px] pl-[25px] text-[#888] text-center text text-[1.6rem]">#333</span>
