...
watch(
    ...
    newLength => {
        ...
        // Nếu productLength tăng, thêm các phần tử mới vào valueCombi
        ...
        // Nếu productLength giảm, cắt bớt các phần tử trong valueCombi
        ...
        >
            <div class="relative">
                ...
                <div>
                    ...
                    >
                        <div
                            class="w-[102px] text-center py-[24px] px-[16px] mt-[-1px] ml-[1px] first:ml-0"
                            style="border: 1px solid #e5e5e5"
                        >
                            {{ n.value }}
                        </div>
            ...
            <div class="relative w-full h-full ml-[-1px]">
                ...
                <div>
                    ...
                    >
                        <div
                            class="min-h-[70px] w-[202px] p-[16px] mt-[-1px] ml-[-1px] first:ml-0"
                            style="border: 1px solid #e5e5e5"
                        >
                            <input
